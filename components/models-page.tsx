...
const defaultModels: ModelEntry[] = [
  {
    ...
    category: "stt",
    size: "75 MB",
    description: "Fastest speech-to-text. Good for quick notes and short dictations.",
    speed: "Fast",
    ramRequired: "~1 GB",
    downloaded: true,
    active: true,
  ...
  },
  {
    ...
    category: "stt",
    size: "466 MB",
    description: "Higher accuracy for complex vocabulary and accents.",
    speed: "Quality",
    ramRequired: "~3 GB",
    downloaded: false,
    active: false,
  },
  {
    ...
    category: "stt",
    size: "1.5 GB",
    description: "Best transcription quality. Requires more memory and processing time.",
    speed: "Quality",
    ramRequired: "~5 GB",
    downloaded: false,
    active: false,
